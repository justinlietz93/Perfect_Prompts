pub fn single_text_style_extraction_prompt(text: &str, style_target: Option<&str>) -> String {
    format!(r#"
...
{}
"#, style_target.unwrap_or("not specified"), text.unwrap_or("not specified"), r#"
...
pub fn chunk_style_analysis_prompt(text: &str, style_target: Option<&str>) -> String {
    format!(r#"
...
pub fn reduce_style_analyses_prompt(text: &str, style_target: Option<&str>) -> String {
    format!(r#"
