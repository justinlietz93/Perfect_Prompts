export const CHUNK_SUMMARY_PROMPT_TEMPLATE_ENTITY_RELATIONSHIP_DIGEST = (text: string) => `
...
export const REDUCE_SUMMARIES_PROMPT_TEMPLATE_ENTITY_RELATIONSHIP_DIGEST = (text: string) => `
