...
// SingleTextStyleExtractionPrompt generates a prompt template
func SingleTextStyleExtractionPrompt(text string, style_target *string) string {
	style_target_val := "not specified"
	if style_target != nil {
		style_target_val = *style_target
	}

	text_val := "not specified"
	if text != nil {
		text_val = *text
	}
...
// ChunkStyleAnalysisPrompt generates a prompt template
func ChunkStyleAnalysisPrompt(text string, style_target *string) string {
	style_target_val := "not specified"
	if style_target != nil {
		style_target_val = *style_target
	}
...
// ReduceStyleAnalysesPrompt generates a prompt template
func ReduceStyleAnalysesPrompt(text string, style_target *string) string {
	style_target_val := "not specified"
	if style_target != nil {
		style_target_val = *style_target
	}
