...
// GenerateMermaidFromDigestPrompt generates a prompt template
func GenerateMermaidFromDigestPrompt(digest string) string {
	return fmt.Sprintf(`
...
// GenerateSimplifiedMermaidPrompt generates a prompt template
func GenerateSimplifiedMermaidPrompt(digest string) string {
	return fmt.Sprintf(`
...
// CorrectMermaidSyntaxPrompt generates a prompt template
func CorrectMermaidSyntaxPrompt(invalid_code string, error_message string, relevant_docs string) string {
	return fmt.Sprintf(`
...
// GenerateReverseEngineeringMermaidPrompt generates a prompt template
func GenerateReverseEngineeringMermaidPrompt(report string) string {
	return fmt.Sprintf(`
