...
// ChunkSummaryPromptProsConsTable generates a prompt template
func ChunkSummaryPromptProsConsTable(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptProsConsTable generates a prompt template
func ReduceSummariesPromptProsConsTable(text string) string {
	return fmt.Sprintf(`
