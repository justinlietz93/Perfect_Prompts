...
// ChunkSummaryPromptMetricsDashboard generates a prompt template
func ChunkSummaryPromptMetricsDashboard(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptMetricsDashboard generates a prompt template
func ReduceSummariesPromptMetricsDashboard(text string) string {
	return fmt.Sprintf(`
