...
// ChunkSummaryPromptSystemWalkthrough generates a prompt template
func ChunkSummaryPromptSystemWalkthrough(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptSystemWalkthrough generates a prompt template
func ReduceSummariesPromptSystemWalkthrough(text string) string {
	return fmt.Sprintf(`
