...
// ChunkSummaryPromptStakeholderMap generates a prompt template
func ChunkSummaryPromptStakeholderMap(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptStakeholderMap generates a prompt template
func ReduceSummariesPromptStakeholderMap(text string) string {
	return fmt.Sprintf(`
