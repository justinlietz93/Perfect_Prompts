...
// ChunkSummaryPromptRiskRegister generates a prompt template
func ChunkSummaryPromptRiskRegister(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptRiskRegister generates a prompt template
func ReduceSummariesPromptRiskRegister(text string) string {
	return fmt.Sprintf(`
