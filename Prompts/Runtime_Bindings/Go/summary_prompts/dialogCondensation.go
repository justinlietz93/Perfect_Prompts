...
// ChunkSummaryPromptDialogCondensation generates a prompt template
func ChunkSummaryPromptDialogCondensation(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptDialogCondensation generates a prompt template
func ReduceSummariesPromptDialogCondensation(text string) string {
	return fmt.Sprintf(`
