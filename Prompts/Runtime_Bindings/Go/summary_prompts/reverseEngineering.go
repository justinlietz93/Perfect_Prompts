...
// ChunkSummaryPromptReverseEngineering generates a prompt template
func ChunkSummaryPromptReverseEngineering(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptReverseEngineering generates a prompt template
func ReduceSummariesPromptReverseEngineering(text string) string {
	return fmt.Sprintf(`
