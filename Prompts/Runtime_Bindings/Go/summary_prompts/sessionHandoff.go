...
// ChunkSummaryPromptSessionHandoff generates a prompt template
func ChunkSummaryPromptSessionHandoff(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptSessionHandoff generates a prompt template
func ReduceSummariesPromptSessionHandoff(text string) string {
	return fmt.Sprintf(`
