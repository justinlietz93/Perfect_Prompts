...
// ChunkSummaryPromptPitchGenerator generates a prompt template
func ChunkSummaryPromptPitchGenerator(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptPitchGenerator generates a prompt template
func ReduceSummariesPromptPitchGenerator(text string) string {
	return fmt.Sprintf(`
