def next_steps_technical_summary_prompt(summary: str) -> str:
...
def next_steps_style_model_prompt(style_description: str, style_target: str = None) -> str:
    """Generated prompt template function."""
...
If a specific person/character was targeted for the style analysis ({style_target}), tailor the suggestions accordingly.
Format your response as a JSON array of strings.
