export const CHUNK_SUMMARY_PROMPT_TEMPLATE_DIALOG_CONDENSATION = (text: string) => `
...
export const REDUCE_SUMMARIES_PROMPT_TEMPLATE_DIALOG_CONDENSATION = (text: string) => `
