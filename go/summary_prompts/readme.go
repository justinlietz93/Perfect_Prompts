...
// ChunkSummaryPromptReadme generates a prompt template
...
// ReduceSummariesPromptReadme generates a prompt template
func ReduceSummariesPromptReadme(text string) string {
	return fmt.Sprintf(`
