...
// ChunkSummaryPromptRaciSnapshot generates a prompt template
func ChunkSummaryPromptRaciSnapshot(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptRaciSnapshot generates a prompt template
func ReduceSummariesPromptRaciSnapshot(text string) string {
	return fmt.Sprintf(`
