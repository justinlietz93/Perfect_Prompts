...
// ChunkSummaryPromptQaPairs generates a prompt template
func ChunkSummaryPromptQaPairs(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptQaPairs generates a prompt template
func ReduceSummariesPromptQaPairs(text string) string {
	return fmt.Sprintf(`
