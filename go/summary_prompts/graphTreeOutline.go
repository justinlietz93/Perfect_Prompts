...
// ChunkSummaryPromptGraphTreeOutline generates a prompt template
func ChunkSummaryPromptGraphTreeOutline(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptGraphTreeOutline generates a prompt template
func ReduceSummariesPromptGraphTreeOutline(text string) string {
	return fmt.Sprintf(`
