...
// ChunkSummaryPromptEntityRelationshipDigest generates a prompt template
func ChunkSummaryPromptEntityRelationshipDigest(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptEntityRelationshipDigest generates a prompt template
func ReduceSummariesPromptEntityRelationshipDigest(text string) string {
	return fmt.Sprintf(`
