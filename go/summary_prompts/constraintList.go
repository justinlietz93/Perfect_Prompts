...
// ChunkSummaryPromptConstraintList generates a prompt template
func ChunkSummaryPromptConstraintList(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptConstraintList generates a prompt template
func ReduceSummariesPromptConstraintList(text string) string {
	return fmt.Sprintf(`
