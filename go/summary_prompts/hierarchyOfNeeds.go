...
// ChunkSummaryPromptHierarchyOfNeeds generates a prompt template
func ChunkSummaryPromptHierarchyOfNeeds(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptHierarchyOfNeeds generates a prompt template
func ReduceSummariesPromptHierarchyOfNeeds(text string) string {
	return fmt.Sprintf(`
