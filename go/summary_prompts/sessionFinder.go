...
// ChunkSummaryPromptSolutionFinder generates a prompt template
func ChunkSummaryPromptSolutionFinder(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptSolutionFinder generates a prompt template
func ReduceSummariesPromptSolutionFinder(text string) string {
	return fmt.Sprintf(`
