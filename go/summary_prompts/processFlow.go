...
// ChunkSummaryPromptProcessFlow generates a prompt template
func ChunkSummaryPromptProcessFlow(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptProcessFlow generates a prompt template
func ReduceSummariesPromptProcessFlow(text string) string {
	return fmt.Sprintf(`
