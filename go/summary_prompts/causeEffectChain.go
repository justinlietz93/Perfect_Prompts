...
// ChunkSummaryPromptCauseEffectChain generates a prompt template
func ChunkSummaryPromptCauseEffectChain(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptCauseEffectChain generates a prompt template
func ReduceSummariesPromptCauseEffectChain(text string) string {
	return fmt.Sprintf(`
