...
// ChunkSummaryPromptPriorityRanking generates a prompt template
func ChunkSummaryPromptPriorityRanking(text string) string {
	return fmt.Sprintf(`
...
// ReduceSummariesPromptPriorityRanking generates a prompt template
func ReduceSummariesPromptPriorityRanking(text string) string {
	return fmt.Sprintf(`
