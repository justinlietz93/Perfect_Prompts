...
// ScaffolderPlanningPrompt generates a prompt template
func ScaffolderPlanningPrompt(prompt string, settings string) string {
	return fmt.Sprintf(`
...
// ScaffolderFilePromptGeneration generates a prompt template
func ScaffolderFilePromptGeneration(project_context string, file string) string {
	return `
