...
// PromptEnhancerPrompt generates a prompt template
func PromptEnhancerPrompt(raw_prompt string, template string) string {
	return fmt.Sprintf(`
...
2.  **Select Template:** Use the structure of the specified template ('%s').
