...
import type { ScaffolderSettings, ScaffoldPlan, ScaffoldTreeItem } from '../../types';

export const SCAFFOLDER_PLANNING_PROMPT_TEMPLATE = (prompt: string, settings: ScaffolderSettings) => `
...
export const SCAFFOLDER_FILE_PROMPT_GENERATION_TEMPLATE = (projectContext: ScaffoldPlan['project'], file: ScaffoldTreeItem) => `
