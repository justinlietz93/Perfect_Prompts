def chunk_summary_prompt_template_checklist(text: str) -> str:
    """Generate a prompt template for extracting checklist items from document segments."""
    return f"""
...
def reduce_summaries_prompt_template_checklist(text: str) -> str:
    """Generate a prompt template for synthesizing checklist items from multiple segments."""
    return f"""
