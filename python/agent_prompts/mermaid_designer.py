def generate_mermaid_from_digest_prompt(digest: str) -> str:
...
def generate_simplified_mermaid_prompt(digest: str) -> str:
    """Generated prompt template function."""
    return f"""
...
def correct_mermaid_syntax_prompt(invalid_code: str, error_message: str, relevant_docs: str) -> str:
    """Generated prompt template function."""
    return f"""
...
def generate_reverse_engineering_mermaid_prompt(report: str) -> str:
    """Generated prompt template function."""
    return f"""
