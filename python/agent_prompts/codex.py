"""
Prompt template and builder for Python.
Usage:
    from prompt import build_prompt
    print(build_prompt("September 30, 2025", "VDM Physics Checklist"))
"""
...
def build_prompt(todays_date: str, checklist_name: str) -> str:
    """
