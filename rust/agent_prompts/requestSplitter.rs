pub fn request_splitter_planning_prompt(spec: &str, settings: &str) -> String {
    format!(r#"
...
pub fn request_splitter_generation_prompt(project_context: &str, current_prompt_title: &str, current_prompt_id: &str, completed_prompt_titles: &str, title: &str) -> String {
    format!(r#"
...
---
[#${{currentPromptId.toString().padStart(2, '0')}}] {}

**PROJECT CONTEXT**
- **Application:** ${{projectContext.name}}
- **Architecture:** ${{projectContext.architecture}}
- **Invariants:**
${{projectContext.invariants.map(inv => `  - {}`).join('\n')}}
...
**FEATURE REQUEST**
- **Modify the existing codebase** to implement exactly one new feature: **{}**.
